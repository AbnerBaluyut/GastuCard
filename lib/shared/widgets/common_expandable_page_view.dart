...
class CommonExpandablePageView extends StatefulWidget {
  ...
  ///
  /// By default (false) [CommonExpandablePageView] will resize to the size of it's
  ...
  /// [CommonExpandablePageView] size animation. This can lead to a behaviour
  /// when after changing the page, [CommonExpandablePageView] will first shrink to 0.0
  /// and then animate to the size of the page.
  ///
  /// For example: If there is certainty that most pages displayed by [CommonExpandablePageView]
  ...
  const CommonExpandablePageView({
  ...
  const CommonExpandablePageView.builder({
  ...
  @override
  CommonExpandablePageViewState createState() => CommonExpandablePageViewState();
}

class CommonExpandablePageViewState extends State<CommonExpandablePageView> {
  ...
  @override
  void didUpdateWidget(covariant CommonExpandablePageView oldWidget) {
  ...
  bool _shouldReinitializeHeights(CommonExpandablePageView oldWidget) {
